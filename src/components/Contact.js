    ...
    return (
        <footer className="text-muted">
            <div className="container">
                ...
                <a href="https://www.linkedin.com/in/raquelroblesbonilla/" target="_blank"><img src="images/linkedin-logo.png"/></a>
                <a href="https://github.com/RaquelRB" target="_blank"><img src="images/github-footer.png"/></a>
            </div>
        </footer>
    )
}
